...
# 2. INISIALISASI MEMORI (Session State) agar data tidak hilang saat refresh
...
with st.sidebar:
    ...
    # Memilih mata pelajaran yang akan dinilai
...
with st.container(border=True):
    ...
    if mapel_terpilih:
        ...
        st.warning("Pilih minimal satu mata pelajaran di menu samping.")
